...
DEFAULT_DB = "/Volumes/T7 Shield/kch-organized/dicom_index.db"
DEFAULT_BASE = "/Volumes/T7 Shield/kch-organized"
DEFAULT_OUT = PROJECT_ROOT / "train" / "dataset" / "phase2"
